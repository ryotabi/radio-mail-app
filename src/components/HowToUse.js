                    ...
                    <div className="howToUse_items">
                        <Box m={4}>
                            ...
                            <ul className="howToUse_item_texts">
                                <li className="howToUse_item_text"><Link to='/form' className="howToUse_link">こちらのフォーム</Link>に入力することで、ラジオ番組へメールを送ることができますできます。</li>
                                <li className="howToUse_item_text">「ユーザー情報をセット」では、アカウント作成時に登録したユーザー登録をセットすることができますできます。</li>
                                <li className="howToUse_item_text">マイ番組を<Link to='/myProgram' className="howToUse_link">設定</Link>することで、デフォルトで登録されているラジオ番組以外の自分がよく聴くラジオ番組を設定することができますできます。</li>
                                <li className="howToUse_item_text">テンプレを<Link to='/template' className="howToUse_link">設定</Link>することで、オリジナルの投稿内容のフォーマットを利用することができますできます。</li>
                            </ul>
                        </Box>
                        <Box m={4}>
